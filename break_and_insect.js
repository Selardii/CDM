...
document.body.innerHTML = `
    ...
    <a href="https://www.csabitasboljeles.hu/s1/games" class="button">Volver a Corazón de Melón 🍈💖</a>
...
async function startMiniGames() {
    try {
        ...
        var games = [
          { method: "GET", url: "https://api3.csabitasboljeles.hu/v2/minigame/break-basket", body: null, name: "Break Basket 1/2" },
          { method: "POST", url: "https://api3.csabitasboljeles.hu/v2/minigame/break-basket", body: JSON.stringify({"score":10}), name: "Break Basket 2/2" },
          { method: "GET", url: "https://api3.csabitasboljeles.hu/v2/minigame/insect-rush", body: null, name: "Insect Rush 1/2" },
          { method: "POST", url: "https://api3.csabitasboljeles.hu/v2/minigame/insect-rush", body: JSON.stringify({"score":10}), name: "Insect Rush 2/2" }
        ];
